            ...
            <View style={styles.loginpage}>
                <View>
                    <TouchableOpacity
                        ...
                        <Ionicons name="arrow-back-circle-sharp" size={40} color="rgba(50,205,50,0.4)" />
                    </TouchableOpacity>
                    <Text
                        style={styles.Login}
                    >Login</Text>
                    ...
                    <View>
                        <TextInput style={styles.input}
                            ...
                            <MaterialCommunityIcons
                                name="onepassword" size={24} color="black" />
                            <Text>
                                PassWord
                        </Text>
                        </TextInput>
                ...
                <View style={styles.social}>
                    <View style={styles.socialall}>
                        <TouchableOpacity onPress={() => console.log("hey Mahmoud")}>
                            <Entypo name="facebook-with-circle" size={50} color="rgba(50,205,50,0.4)" />
                        </TouchableOpacity>
                    </View>

                    <View style={styles.socialall}>
                        <Entypo name="twitter-with-circle" size={50} color="rgba(50,205,50,0.4)" />
                    </View>
                    <View style={styles.socialall}>
                        <Entypo name="instagram-with-circle" size={50} color="rgba(50,205,50,0.4)" />
                    </View>
                </View>
                <View>
                    <Text style={styles.note}>
                        Enjoy Always will be for Free
                        {"\n"}
                        Happy to have you
                  </Text>
                </View>
