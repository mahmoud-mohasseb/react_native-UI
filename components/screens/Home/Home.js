    ...
    return (
        ...
        <ImageBackground source={img} style={styles.image} >
            <View style={styles.Header} >
                {/* <TouchableOpacity
                // onPress={() => navigation.navigate("DrawerList")}
                // onPress={navigation.dispatch(jumpToAction)}
                > */}
                <AntDesign
                    name="menuunfold" size={30}
            ...
            <View>
                ...
                <ScrollView
                    ...
                    <TouchableOpacity
                        ...
                        <Icon name="dog" color="black" size={25} />
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={styles.choice2extra1}>
                        <Icon name="office-building" color="black" size={25} />
                    </TouchableOpacity>

                    <TouchableOpacity
                        style={styles.choice2extra2}>
                        <Icon name="cat" color="black" size={25} />
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.choice2extra3}
                        onPress={() => navigation.navigate("About")}>
                        <Icon name="bus"
                            color="black"
                            size={25} />
                    ...
                    <View
                        style={styles.choice4}>
                        <Icon name="dots-horizontal" color="black" size={25} />
                    </View>
                </ScrollView>
            </View>
            <ScrollView>
                ...
                <ScrollView
                    ...
                    <TouchableOpacity
                        ...
                        {/* <View style={styles.forsale}>
                            <Text style={styles.textforsale}>For Sale</Text>
                        </View> */}
                        <View
                            style={{
                            ...
                            <Image
                                source={img3}
                                style={{ width: 180, borderRadius: 20, height: 130 }}
                            />
                            <View
                                style={{
                                    flexDirection: "row",
                                ...
                                <View
                                    ...
                                    <Text
                                        ...
                                        Meen impsum dolor sit amet, consectetuer adipscing elit,
                                </Text>
                                </View>
                        ...
                        <View
                            ...
                            <View
                                ...
                                <Text
                                    ...
                                    waalla impsum dolor sit amet, consectetuer adipscing elit,
                             </Text>
                            </View>
                    ...
                    <View
                        ...
                        >
                            ...
                            <Icon name="map-marker" size={25} color="#bb32fe"
                                onPress={() => navigation.navigate("ComLocation")}
                            />
                        </View>
                    </View>
                    {/* second main page scroll */}
                </ScrollView>
                <View style={styles.title1}>
            ...
            >
                <TouchableHighlight onPress={Icon}>
                    <Icon
                        name="home"
                        color="green" size={30}
                        onPress={() =>
                ...
                <TouchableHighlight onPress={Icon}>
                    <Icon name="dog" color="green" size={30}
                        onPress={() => navigation.navigate("About")}
                    />
                </TouchableHighlight>
                <Icon name="cat" color="green" size={30} />
